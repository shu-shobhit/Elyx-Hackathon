...
```json
{
  ...
  "analysis": "string", // Your coordination analysis and reasoning for any decisions made.
  "recommendations": ["string"], // List of specific recommendations or decisions made.
  "medications": ["string"], // List of any medications recommended (usually empty for Ruby).
...
```json
{
  ...
  "analysis": "string", // Your clinical analysis and reasoning for any decisions made.
  "recommendations": ["string"], // List of specific recommendations or decisions made.
  "medications": ["string"], // List of any medications prescribed or recommended.
  "tests": ["string"], // List of any diagnostic tests ordered or recommended.
  "confidence": 0.0-1.0, // Your confidence level in the recommendations (0.0 to 1.0).
  "proposed_event": {
...
```json
{
  ...
  "analysis": "string", // Your data analysis and reasoning for any decisions made.
  "recommendations": ["string"], // List of specific recommendations or decisions made.
  "medications": ["string"], // List of any medications recommended (usually empty for Advik).
  "tests": ["string"], // List of any diagnostic tests recommended.
  "confidence": 0.0-1.0, // Your confidence level in the recommendations (0.0 to 1.0).
...
```json
{
  ...
  "analysis": "string", // Your nutritional analysis and reasoning for any decisions made.
  "recommendations": ["string"], // List of specific recommendations or decisions made.
  "medications": ["string"], // List of any medications recommended (usually empty for Carla).
  "tests": ["string"], // List of any diagnostic tests recommended.
  "confidence": 0.0-1.0, // Your confidence level in the recommendations (0.0 to 1.0).
  "proposed_event": {
...
```json
{
  ...
  "analysis": "string", // Your physical assessment and reasoning for any decisions made.
  "recommendations": ["string"], // List of specific recommendations or decisions made.
  "medications": ["string"], // List of any medications recommended (usually empty for Rachel).
  "tests": ["string"], // List of any diagnostic tests recommended.
  "confidence": 0.0-1.0, // Your confidence level in the recommendations (0.0 to 1.0).
...
```json
{
  ...
  "analysis": "string", // Your strategic analysis and reasoning for any decisions made.
  "recommendations": ["string"], // List of specific recommendations or decisions made.
  "medications": ["string"], // List of any medications recommended (usually empty for Neel).
  "tests": ["string"], // List of any diagnostic tests recommended.
  "confidence": 0.0-1.0, // Your confidence level in the recommendations (0.0 to 1.0).
...
At the beginning of each thread Ruby should be the first point of contact most of the times.
...
```json
{
  ...
  "analysis": "string", // Your comprehensive assessment analysis and reasoning for any decisions made.
  "recommendations": ["string"], // List of specific recommendations or decisions made.
